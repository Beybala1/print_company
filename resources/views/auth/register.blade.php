...
<body>
    <div style="margin-top:3%;" class="container-xxl col-4">
                        ...
                        <form id="main_form" class="mb-3" action="{{ route('register') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="name" name="name" value="{{old('name')}}"
                                    placeholder="İstifadəçi adını daxil edin" autofocus required />
                            </div>
                            ...
                            <button type="submit" class="btn btn-primary d-grid w-100">Qeydiyyatdan keç</button>
                        </form>
